...
public class TileEntityGrinder extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "Grinder";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                GrinderBlock.setState(this.isBurning(), this.worldObj, this.pos);
            }
    ...
    public static int getItemBurnTime(ItemStack stack)
    {
        ...
        { 
         ...
         //   if (item == Items.STICK) return 100;
            if (item == DefineCraftModItems.GrinderHead) return 4000;
    ...
    {
        if(DefineCraftModItems.GrinderHead != null){
        	return true;
        }
