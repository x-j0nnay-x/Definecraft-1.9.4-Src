...
import com.DefineCraft.Core.GUINames;
...
public class GrinderLogic extends TileEntityLockable implements  ISidedInventory {
    ...
    private String furnaceCustomName = GUINames.Grinder;
    ...
    public void update() {
        ...
        if (this.isBurning() && this.cookTime >= 0) { //stops the cook time
