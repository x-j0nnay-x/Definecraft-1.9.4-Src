...
public class GrinderBlock extends BlockContainer
{
    ...
    public GrinderBlock(boolean isBurning, String name)
    {
        super(Material.ROCK);
    ...
    {
        return Item.getItemFromBlock(DefineCraftModBlocks.Grinder);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        {
            worldIn.setBlockState(pos, DefineCraftModBlocks.Grinder.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, DefineCraftModBlocks.Grinder.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    {
        return new ItemStack(DefineCraftModBlocks.Grinder);
    }
